...
//    virtual void update() override;
    Knight(const string& name, Point &startingLocation,int state = stopped, int health = GOD_MODE, int speed = 10) :_type("Knight"), Agent(name,health,state,startingLocation,speed){}
